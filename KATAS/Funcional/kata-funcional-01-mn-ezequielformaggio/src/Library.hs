...
--Durante un entrenamiento físico de una hora, cada 10 minutos de entrenamiento 
--se tomóo la frecuencia cardíaca de uno de los participantes obteniéndose un total de 7 muestras que son las siguientes:
...
promedioFrecuenciaCardiaca frecuenciaCardiaca = (/) (sum frecuenciaCardiaca) (length frecuenciaCardiaca)
